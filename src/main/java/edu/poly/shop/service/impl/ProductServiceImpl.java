...
import edu.poly.shop.respository.ProductReponsitory;
...
public class ProductServiceImpl implements ProductService {
	...
	public ProductServiceImpl(ProductReponsitory productResponsitory) {
		this.productReponsitory = productResponsitory;
		
	}

	@Override
	public Page<Product> findByNameContaining(String name, Pageable pageable) {
		return productReponsitory.findByNameContaining(name, pageable);
	}
